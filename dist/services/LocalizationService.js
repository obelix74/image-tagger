...
class LocalizationService {
     ...
     */
    static getLocalizedPrompt(language = this.currentLanguage) {
        const prompts = {
            ...
            sv: `Analysera denna bild och tillhandahåll följande information i JSON-format:
{
  ...
  "confidence": 0.95
     ...
     */
    static isRTL(language = this.currentLanguage) {
     ...
     */
    static getTextDirection(language = this.currentLanguage) {
        return this.isRTL(language) ? 'rtl' : 'ltr';
    }
}
exports.LocalizationService = LocalizationService;
LocalizationService.SUPPORTED_LANGUAGES = [
